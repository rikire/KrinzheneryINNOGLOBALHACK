...
export interface CommitInfo {
  additions: number; // Количество добавленных строк
  deletions: number; // Количество удаленных строк
  commit_date: string; // Дата коммита
  commit_message: string; // Сообщение коммита
}

export interface RepoActivity {
  commits: CommitInfo[]; // Описания коммитов
}
